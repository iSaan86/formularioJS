...
var seleccion= opciones[i].selectedIndex

    if(opciones.selectedIndex>0){
        // alert( 'correcto')
        // console.log(opciones.selectedIndex)
        console.log(opciones)
        var cual= opciones[i].selectedIndex
        if(opciones[i].selectedIndex){
            alert('Has seleccionado ' +opciones)
        }
        // if(opciones.selectedIndex==1){
        //     alert('Ha selecionado Jerez')
        // }
        // if(opciones.selectedIndex==2){
        //     alert('Ha selecionado Sanlucar')
        // }
        // if(opciones.selectedIndex==3){
        //     alert('Ha selecionado El Puerto de Sta. María')
        // }
        // if(opciones.selectedIndex==4){
        //     alert('Ha selecionado Puerto Real')
        // }
