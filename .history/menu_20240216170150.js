...
function desplegable(){
    ...
    if(provincia.value=="cadiz"){
        console.log('Cadiz')
        document.getElementById('provMensaje').innerHTML='<select id="ciudadesCai" name="ciudadesCai"  alt="Elije Ciudad"><option hidden>Seleccione</option><option value="jerez">Jerez de la Fra.</option><option value="cadiz">Cádiz</option><option value="Sanlúcar">Sanlucar de Barrameda</option><option value="puerto">El Puerto de Sta María</option><option value="cadiz">Cádiz</option> </select>'
    }
