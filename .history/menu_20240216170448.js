...
function desplegable(){
    ...
    if(provincia.value=="sevilla"){
        console.log('Sevilla');
        document.getElementById('provMensaje').innerHTML='<select id="ciudadesSev" name="ciudadesSev"  alt="Elije Ciudad"><option hidden>Seleccione</option><option value="doshermanas">Dos Hermanas</option><option value="sevillaC">Sevilla Ci</option><option value="Sanlúcar">Sanlucar de Barrameda</option><option value="puerto">El Puerto de Sta María</option><option value="cadiz">Puerto Real</option> </select>'
    }
}
