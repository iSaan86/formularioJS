...
//         document.getElelemtsByName('genero').value = "";
//         // return false;
//     }
// }
// // otra forma de validar tipe radio, para solo 1 seleccion:
...
// otra forma de validar tipe radio, para varias selecciones:
function compRadio(radio){
    let radio = document.querySelectorAll('input[name="genero"]');
