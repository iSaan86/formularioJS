...
for(i=0;i<fiesta.length;i++){
    ...
    if(fiesta[i].checked==5){
        flag=true;
        alert('hay solo una fiesta checkeada. Seleccione 2 más')
        
    }else{
        document.getElementById('fiestasMensaje').innerHTML="<img src='img/alerta.svg' alt='alerta' width='15px'>Campo vacío";
