...
function desplegable(){
    ...
    if(provincia.value=="cadiz"){
        console.log('Cadiz')
        document.getElementById('provMensaje').innerHTML='<select id="ciudadesCai" name="ciudadesCai"  alt="Elije Ciudad"><option hidden>Seleccione</option><option value="jerez">Jerez</option><option value="sevilla">Sevilla</option> </select>'
    }
