...
var longitud =  opciones.length;
    ...
    if(opciones.selectedIndex>0){
        ...
        if(opciones.selectedIndex==1){
            console.log('Ha selecionado Jerez')
        }
        if(opciones.selectedIndex==2){
            console.log('Ha selecionado Sanlucar')
        }
        if(opciones.selectedIndex==3){
            console.log('Ha selecionado El Puerto de Sta. María')
        }
        if(opciones.selectedIndex==4){
            console.log('Ha selecionado Puerto Real')
        }
