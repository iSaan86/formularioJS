...
if(email==""){
    ...
    document.getElementById('emaillMensaje').style.fontSize="smaller";
    document.getElementById('email').value = ""; 
    // return false;
}else{
    if(!patronMail.test(email)){
        document.getElementById('emailMensaje').innerHTML="Formato incorrecto. Siga el formato indicado";
        document.getElementById('emailMensaje').style.color="red";
        document.getElementById('telMensaje').style.fontSize="smaller";
        document.getElementById('telefono').focus();
        document.getElementById('telefono').value = "";
